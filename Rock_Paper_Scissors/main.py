...
print("Welcome to the a game of Rock, Paper, Scissors...")
#Get user input
...
for game_round in range(rounds):
    ...
    if p_choice in moves:
        ...
        elif p_choice == 'rock' and c_choice == 'rock':
            winner = 'player'
    ...
    #Else the player did nto make a valie move
    else:
        print("That is not a valide option!")
