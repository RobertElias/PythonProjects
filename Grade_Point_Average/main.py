...
#Get users desired average and calculate what they need to get on the next assignment
...
#Print Summary
print("\nGood luck "+ name + "!")
print("You will need to get a " + str(grade_req) + " on your next assignment to earn a "
+ str(desired_avg) + " average.")

#Make Copy of original grades and swapt out one of the grades
new_grades = grades[:]
